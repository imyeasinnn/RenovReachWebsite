...
var uu = `modulepreload`,
    ...
    mu = {
        IndexRoute: kc(`/`)({
            head: () => ({
                meta: [{
                    title: `RenovReach | AI Receptionist & Meta Ads`
                }, {
                    name: `description`,
                    content: `RenovReach helps contractors generate homeowner leads with Meta Ads and convert every call with an AI receptionist.`
                }, {
                    property: `og:title`,
                    content: `RenovReach | AI Receptionist & Meta Ads`
                }, {
                    property: `og:description`,
                    content: `Generate homeowner leads and turn every call into a booked opportunity with RenovReach.`
                }, {
                    property: `og:type`,
                    content: `website`
                }, {
            ...
            component: jc(() => pu(() =>
                import (`./routes-4inkyfqG.js?v=3`), []), `component`)
        }).update({
            id: `/`,
            path: `/`,
            getParentRoute: () => su
